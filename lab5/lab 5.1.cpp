...
public:
    ...
    void IdentificationМerticesM(int v1, int v2) {
        for (int i = 0; i < numVerticesM; i++) {
            if (adjMatrix[v2][i] > 0) {
    ...
    void IdentificationМerticesS(int v1, int v2) {
...
int main()
{
    ...
    cout<<endl << "Введите вершины для операции стягивания-ребра: ";
    cin >> t >> y;
    cout << endl << endl << "Сжатие вершины-ребра графа(Матрица)"<<endl;
    c.contractEdgeM(t, y);
    c.contractEdgeS(t, y);
    cout << endl << "Матрица смежности: \n";
    c.toMatrix();
    ...
    //cout<<endl << "Введите вершины для операции отождествления вершин: ";
    //cin >> t >> y;
    //c.IdentificationМerticesM(t, y);
    //c.IdentificationМerticesS(t, y);
    //cout << endl << "Матрица смежности: \n";
    //c.toMatrix();
    //cout << endl << "Cписок смежности: \n";
    //c.toSpisok();
    ...
    //c.splittingVertexM(1);
    //c.toMatrix();

    //cout << endl << endl << "расщеплениe вершины графа(Список)" << endl;
